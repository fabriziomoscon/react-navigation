...
const StackInTab = StackNavigator({
  StackB: { screen: () => null },
});
const TestNavigator = TabNavigator({
  TabA: { screen: StackInTab },
});
const testState = TestNavigator.router.getStateForAction(TestNavigator.router.getActionForPathAndParams('TabA'));
